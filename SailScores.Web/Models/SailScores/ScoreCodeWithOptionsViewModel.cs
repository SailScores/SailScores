...
public class ScoreCodeWithOptionsViewModel : ScoreCodeViewModel
{
    public List<SelectListItem> FormulaOptions { get; } = new List<SelectListItem>
    {
        ...
        new SelectListItem("AVE W - Average of other results (whole number)", "AVE W"),
        new SelectListItem("AVE W P - Average of previous results (whole number)", "AVE W P"),
        new SelectListItem("AVE W ND - Average of all non-discarded races (whole number)", "AVE W ND"),
