...
namespace SailScores.Database.Migrations
{
    ...
    [Migration("20260903001829_AddHighlyVisibleToCompetitorFieldDefinition")]
    partial class AddHighlyVisibleToCompetitorFieldDefinition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SailScores.Database.Entities.ChangeType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("9b1af84e-8179-4345-9583-2bf741b111bd"),
                            Name = "Admin Note"
                        },
                        new
                        {
                            Id = new Guid("1c28a4cb-5994-44ec-9b2b-aceb3036256b"),
                            Name = "Merged"
                        });
                });

            modelBuilder.Entity("SailScores.Database.Entities.ClassHandicap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BoatClassId", "HandicapSystemId")
                        .IsUnique()
                        .HasDatabaseName("IX_ClassHandicap_NullEnd")
                        .HasFilter("[EffectiveTo] IS NULL");

                    b.ToTable("ClassHandicaps");
                });
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Club", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultRegattaSeriesResultsTemplateId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultScoringSystemId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultSeriesResultsTemplateId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("EnableAlternativeSailNumbers")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableCustomCompetitorFields")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("DefaultRegattaSeriesResultsTemplateId");

                    b.HasIndex("DefaultScoringSystemId");

                    b.HasIndex("DefaultSeriesResultsTemplateId");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.CompetitorFieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("DisplayHeader")
                        .HasMaxLength(100)
                    ...
                    b.ToTable("CompetitorFieldDefinitions");
                });

            modelBuilder.Entity("SailScores.Database.Entities.CompetitorFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompetitorId", "FieldDefinitionId")
                        .HasDatabaseName("IX_CompetitorFieldValue_CompetitorField");

                    b.ToTable("CompetitorFieldValues");
                });
            ...
            modelBuilder.Entity("SailScores.Database.Entities.CompetitorHandicapStatsSummary", b =>
                {
                    b.Property<double?>("AverageCorrectedRank")
                        .HasColumnType("float");

                    b.Property<int?>("CorrectedBoatsBeat")
                        .HasColumnType("int");

                    b.Property<int?>("CorrectedBoatsRacedAgainst")
                        .HasColumnType("int");

                    b.Property<int?>("CorrectedRaceCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Regatta", b =>
                {
                    ...
                    b.Property<bool?>("HideFromClubHomePage")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.ScoreCode", b =>
                {
                    ...
                    b.Property<decimal?>("FormulaValueDecimal")
                        .HasColumnType("decimal(6, 3)")
                        .HasColumnName("FormulaValue_Decimal");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Series", b =>
                {
                    ...
                    b.Property<bool?>("ChildrenSeriesAsSingleRace")
                        .HasColumnType("bit");

                    b.Property<Guid>("ClubId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool?>("DateRestricted")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateOnly?>("EnforcedEndDate")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("EnforcedStartDate")
                        .HasColumnType("date");
                    ...
                    b.Property<Guid?>("SeriesResultsTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SeriesResultsTemplateId");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.SeriesResultsTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("BoatNameHeader")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("BoatNameVisibility")
                        .HasColumnType("int");

                    b.Property<Guid>("ClubId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("CompetitorClubVisibility")
                        .HasColumnType("int");

                    b.Property<string>("CompetitorNameHeader")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("CompetitorNameVisibility")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SailNumberVisibility")
                        .HasColumnType("int");

                    b.Property<bool>("ShowClubLogo")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowPreDiscardTotal")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SeriesResultsTemplates");
                });

            modelBuilder.Entity("SailScores.Database.Entities.SeriesResultsTemplateCustomField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SeriesResultsTemplateId", "FieldDefinitionId")
                        .HasDatabaseName("IX_TemplateCustomField_TemplateField");

                    b.ToTable("SeriesResultsTemplateCustomFields");
                });
            ...
            modelBuilder.Entity("SailScores.Database.Entities.SeriesToSeriesLink", b =>
                {
                    ...
                    b.Property<Guid>("ChildSeriesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ParentSeriesId", "ChildSeriesId");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.SystemAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Club", b =>
                {
                    ...
                    b.HasOne("SailScores.Database.Entities.SeriesResultsTemplate", null)
                        .WithMany()
                        .HasForeignKey("DefaultRegattaSeriesResultsTemplateId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("SailScores.Database.Entities.SeriesResultsTemplate", null)
                        .WithMany()
                        .HasForeignKey("DefaultSeriesResultsTemplateId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SailScores.Database.Entities.CompetitorFieldDefinition", b =>
                {
                    b.HasOne("SailScores.Database.Entities.Club", "Club")
                        .WithMany("CompetitorFieldDefinitions")
                        .HasForeignKey("ClubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SailScores.Database.Entities.CompetitorFieldValue", b =>
                {
                    ...
                    b.HasOne("SailScores.Database.Entities.CompetitorFieldDefinition", "FieldDefinition")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("SailScores.Database.Entities.HandicapSystem", b =>
                {
                    b.HasOne("SailScores.Database.Entities.HandicapSystem", "ParentSystem")
                        .WithMany()
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Series", b =>
                {
                    ...
                    b.HasOne("SailScores.Database.Entities.SeriesResultsTemplate", "SeriesResultsTemplate")
                        .WithMany()
                        .HasForeignKey("SeriesResultsTemplateId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SeriesResultsTemplate");
                });
            ...
            modelBuilder.Entity("SailScores.Database.Entities.SeriesResultsTemplate", b =>
                {
                    b.HasOne("SailScores.Database.Entities.Club", "Club")
                        .WithMany("SeriesResultsTemplates")
                        .HasForeignKey("ClubId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SailScores.Database.Entities.SeriesToSeriesLink", b =>
                {
                    b.HasOne("SailScores.Database.Entities.Series", "ChildSeries")
                        .WithMany("ParentLinks")
                        .HasForeignKey("ChildSeriesId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SailScores.Database.Entities.Series", "ParentSeries")
                        .WithMany("ChildLinks")
            ...
            modelBuilder.Entity("SailScores.Database.Entities.Club", b =>
                {
                    ...
                    b.Navigation("CompetitorFieldDefinitions");
                    ...
                    b.Navigation("SeriesResultsTemplates");
                });
