...
set @SystemId = (
  SELECT
   Id  
  From ScoringSystems where Name = 'Appendix A Low Point')
  ...
  VALUES
  (NewId(),'TIE','Tied result',1,1,1,NULL,0,1,1,'MAN', NULL, @SystemId),
  ...
  (NewId(),'UFD','Disqualification under rule 30.3',0,1,0,1,NULL,1,0,'CTS+',NULL,@SystemId),  
  (NewId(),'BFD','Disqualification under rule 30.4',0,0,0,1,NULL,1,0,'CTS+',NULL,@SystemId),
  (NewId(),'DNF','Started but did not finish',0,1,1,1,NULL,1,0,'CTS+',NULL,@SystemId),
  (NewId(),'OCS','On course side at start or broke rule 30.1',0,1,0,1,NULL,1,0,'CTS+',NULL,@SystemId),
  (NewId(),'DSQ','Disqualification',0,1,1,1,NULL,1,1,'CTS+',NULL,@SystemId),
  (NewId(),'RDG','Redress: points set by protest hearing',1,1,1,NULL,0,1,1,'MAN',NULL,@SystemId),
  (NewId(),'DNE','Disqualification that is not excludable',0,0,1,1,NULL,1,1,'CTS+',NULL,@SystemId),
